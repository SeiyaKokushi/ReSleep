...
public class TabaccoActivity extends AppCompatActivity {
    double minValues;
    double maxValues;
    ...
    private void setRange(){
        ...
        minValues = loadGraphInfo(4L);

        maxValues = loadGraphInfo(10L);
    }

    private void makeGraph() {
        //グラフビューを作成
        GraphLayout graph = new GraphLayout(this, 5);
