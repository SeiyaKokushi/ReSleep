 ...
 */
public class WakeTimeSetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timePicker.setCurrentHour(loadUserInfo(3L));
        timePicker.setCurrentMinute(loadUserInfo(4L));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(), "起床時間を" + timePicker.getCurrentHour() + "時" + timePicker.getCurrentMinute() + "分に設定しました", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void loadTimeInfo(){
        ...
        int hour = loadUserInfo(7L);
        int min = loadUserInfo(8L);
