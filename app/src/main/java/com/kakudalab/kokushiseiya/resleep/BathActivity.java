...
public class BathActivity extends AppCompatActivity {
    ...
    private void setRange(){
        ...
        minValues = (double)sleepHour + ((double)sleepMin / 60.0) - 6.0;
        maxValues = (double)sleepHour + ((double)sleepMin / 60.0) - 0.5;
    }

    private void makeGraph() {
        //グラフビューを作成
        GraphLayout graph = new GraphLayout(this, 7);
